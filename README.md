...
- IPv4/IPv6 addresses, TCP/UDP ports and TCP flags;
...
Capture also supports in-kernel mark/interface/netns filters, libpcap
expressions, optional kernel stacks, bounded SKB clone/copy tracking and an
agent-safe `--ready-file` synchronization point.

It does **not yet** claim full `pwru` parity. Packet-byte/BTF dumps, tunnel
filters, TC/XDP tracing, module split-BTF discovery and helper/map argument
